package com.juborajsarker.filemanager.manager;
...
/**
 * Created by juborajsarker on 15/9/17.
 */
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            switch (operation) {
                ...
                case OPERATION_POPULATE_LIST:
                    ...
                    filesAndFolders.addAll(fileManager.sort(fileManager.isFileHidden() ? list :
                            fileManager.removeHiddenFiles(list)));
                    break;
        ...
        protected void onPostExecute(Boolean aVoid) {
            ...
            switch (operation) {
                ...
                case OPERATION_COPY:
                    ...
                    Toast.makeText(context, "File successfully copied", Toast.LENGTH_SHORT).show();
                    refreshCurrentDirectory();
                    break;

                case OPERATION_MOVE:
                    progressDialog.dismiss();
                    Toast.makeText(context, "File successfully moved", Toast.LENGTH_SHORT).show();
                    refreshCurrentDirectory();
                    break;

                case OPERATION_DELETE:
                    progressDialog.dismiss();
                    Toast.makeText(context, "Successfully deleted the entry", Toast.LENGTH_SHORT).show();
                    refreshCurrentDirectory();
                    break;
